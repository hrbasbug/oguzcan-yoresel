...
const PRODUCTS = [
  // ---------- SALÇALAR ----------
  { name:"Domates Salçası", size:"450 g", price:160, cat:"Salçalar", img:"domates-salcasi-450g.jpeg",
  ...
  { name:"Domates Salçası", size:"1 Kg", price:330, cat:"Salçalar", img:"domates-salcasi-1kg.jpeg",
  ...
  { name:"Tatlı Biber Salçası", size:"450 g", price:185, cat:"Salçalar", img:"tatli-biber-salcasi-450g.jpeg",
  ...
  { name:"Tatlı Biber Salçası", size:"1 Kg", price:385, cat:"Salçalar", img:"tatli-biber-salcasi-1kg.jpeg",
    desc:"Katkısız, güneşte kurutulmuş tatlı biberden hazırlanan yoğun kıvamlı salça. Ailece tüketim için ekonomik 1 kg boy." },
  { name:"Tatlı Biber Salçası", size:"2 Kg", price:700, cat:"Salçalar", img:"tatli-biber-salcasi-2kg.jpeg",
    desc:"Yoğun kullanan mutfaklar ve kışlık için en avantajlı 2 kg boy. Doğal, katkısız ve el emeği tatlı biber salçası." },
  { name:"Acı Biber Salçası", size:"450 g", price:185, cat:"Salçalar", img:"aci-biber-salcasi-450g.jpeg",
  ...
  { name:"Acı Biber Salçası", size:"2 Kg", price:700, cat:"Salçalar", img:"aci-biber-salcasi-2kg.jpeg",
  ...
  // ---------- SOSLAR ----------
  { name:"Nar Ekşisi", size:"300 g", price:300, cat:"Soslar", img:"nar-eksisi-300g.jpeg",
  ...
  { name:"Nar Ekşisi", size:"575 g", price:450, cat:"Soslar", img:"nar-eksisi-575g.jpeg",
  ...
  // ---------- BAHARATLAR ----------
  { name:"Kimyon", size:"50 g", price:60, cat:"Baharatlar", img:"kimyon.jpeg",
  ...
  { name:"İsot Biber", size:"100 g", price:75, cat:"Baharatlar", img:"isot-biber.jpeg",
  ...
  { name:"Limon Tuzu", size:"50 g", price:null, cat:"Baharatlar", img:"limon-tuzu.jpeg",
    desc:"Doğal limon tuzu. Yemek ve salatalara ferah bir ekşilik verir; kışlık hazırlıklarda da güvenle kullanılır." },
  { name:"Toz Sumak Ekşisi", size:"50 g", price:null, cat:"Baharatlar", img:"toz-sumak.jpeg",
    desc:"Sumak bitkisinden öğütülen doğal ekşi baharat. Salata, soğan ve kebap sofralarının vazgeçilmez, dengeli ekşiliği." },

  // ---------- SİRKELER ----------
  { name:"Enginar Sirkesi", size:"500 ml", price:null, cat:"Sirkeler", img:"enginar-sirkesi.jpeg",
  ...
  { name:"Elma Sirkesi", size:"500 ml", price:null, cat:"Sirkeler", img:"elma-sirkesi.jpeg",
  ...
  { name:"Ananas Sirkesi", size:"500 ml", price:null, cat:"Sirkeler", img:"ananas-sirkesi.jpeg",
